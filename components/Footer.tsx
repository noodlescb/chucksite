        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#demo" className="text-gray-400 hover:text-prime-teal transition-colors">Request Demo</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">Documentation</a></li>
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">API Reference</a></li>
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">Blog</a></li>
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">Community</a></li>
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">Support</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">About Us</a></li>
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">Careers</a></li>
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">Contact</a></li>
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-400 hover:text-prime-teal transition-colors">Terms of Service</a></li>
            </ul>
          </div>
        </div>
